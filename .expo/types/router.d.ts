...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/Navigations/TabNavigation` | `/Screens/BookingScreens/BookingScreen` | `/Screens/HomeScreens/HomeScreen` | `/Screens/LoginScreen/Login` | `/Screens/ProfileScreens/ProfileScreen` | `/_sitemap` | `/hooks/useWarmUpBrowser`;
